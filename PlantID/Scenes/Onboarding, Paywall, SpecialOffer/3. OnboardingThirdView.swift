...
final class OnboardingThirdView: BaseOnboardingView {
    
    override func setupContent() {
        super.setupContent()
        
        currentPage = 1
        textFor1Lbl = TextForThirdOnb.shareYourThoughts
        textFor1GrennLbl = TextForThirdOnb.withUs
        textForSecondTitle = TextForThirdOnb.contributeToOurGrowthBy
        onb = .fird
        nameImgForBg = "new_onb_3"
    }
