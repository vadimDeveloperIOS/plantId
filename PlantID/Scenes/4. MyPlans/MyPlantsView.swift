...
final class MyPlantsView: View {
    ...
    private lazy var headerTitle: UILabel = {
        ...
        view.text = "my_plants_big".localized
    ...
    private lazy var secondTitle: UILabel = {
        let view = UILabel()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.text = "your_garden_is_waiting".localized
    ...
    private lazy var image: UIImageView = {
        ...
        view.translatesAutoresizingMaskIntoConstraints = false
        view.image = UIImage(named: "no.plants.yet")
    ...
    private lazy var greenButtom: UIButton = {
        let view: UIButton = .greenButtonCreateCarePlan
        view.translatesAutoresizingMaskIntoConstraints = false
        view.addAction(
            UIAction(handler: { [weak self] _ in
                guard let self else { return }
                self.actionHandler(.createPlan)
            }),
            for: .touchUpInside)
        return view
    }()
