...
final class AllGoodHereView: View {
    ...
    private lazy var firsTitle: UILabel = {
        let view = UILabel()
        let txt = "all_good_here".localized
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    private lazy var secondTitle: UILabel = {
        let view = UILabel()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.text = "strelitzia_thriving".localized
    ...
    private lazy var image: UIImageView = {
        ...
        view.translatesAutoresizingMaskIntoConstraints = false
        view.image = UIImage(named: "all.good.here")
    ...
    private lazy var tryButton: UIButton = {
        let view = UIButton()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.setBackgroundImage(UIImage(named: "try.again"), for: .normal)
