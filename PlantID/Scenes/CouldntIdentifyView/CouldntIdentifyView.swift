...
final class CouldntIdentifyView: View {
    ...
    private lazy var firsTitle: UILabel = {
        let view = UILabel()
        let txt = "couldnt_identify".localized
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    private lazy var secondTitle: UILabel = {
        let view = UILabel()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.text = "try_again_message".localized
    ...
    private lazy var image: UIImageView = {
        ...
        view.translatesAutoresizingMaskIntoConstraints = false
        view.image = UIImage(named: "couldt.ident")
    ...
    private lazy var tryButton: UIButton = {
        let view = UIButton.greenButtonTryAgain
        view.translatesAutoresizingMaskIntoConstraints = false
        view.addAction(
            UIAction(handler: { [weak self] _ in
                guard let self else { return }
                self.actionHandler(.tryAgain)
            })
            , for: .touchUpInside)
        return view
    }()
